...
import { APIConfig, AppID, OSTheme, VirtualTime, CharacterProfile, CharacterGroup, ChatTheme, Toast, FullBackupData, UserProfile, ApiPreset, GroupProfile, SystemLog, Worldbook, NovelBook, SongSheet, Message, RealtimeConfig, AppearancePreset, CloudBackupConfig, CloudBackupFile, CloudBackupProvider, MemoryPalaceFeatureFlags } from '../types';
                      ...
                      const mediaList = rawData.map((c: CharacterProfile, index: number) => {
                          const extracted = {
                              ...
                              backgrounds: {
                                  ...
                                  videoCallForegroundPlacementSchedule: c.videoCallForegroundPlacementSchedule,
                              }
                          };
