...
type PreloadConnection = { saveData?: boolean; effectiveType?: string };
type PreloadNavigator = { hardwareConcurrency?: number; deviceMemory?: number; connection?: PreloadConnection };
...
export const preloadApp = (id: AppID): void => {
  ...
  if (!request) { requested.delete(id); return; }
