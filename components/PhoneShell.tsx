...
const WorkbenchApp = lazyApp(() => import('../apps/WorkbenchApp'));
...
const APP_PRELOAD_ORDER: PreloadableLazy[] = [
  ...
  WorkbenchApp, XhsStockApp, XhsFreeRoamApp, BrowserApp, VoiceDesignerApp, ThemeMaker, QQBridge,
...
const PhoneShell: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden bg-gradient-to-br from-pink-200 via-purple-200 to-indigo-200 text-slate-900 font-sans select-none overscroll-none">
       ...
       {/* App 背景统一铺满真实 viewport。未迁移 App 仍由外壳 padding 挪开控件；
          已迁移 App 自己使用 --safe-* 给顶栏/底栏让位，外壳不再制造一条底部空白带。 */}
      <div
