...
const GroupChat: React.FC = () => {
    const { closeApp, groups, createGroup, updateGroup, deleteGroup, characters, apiConfig, addToast, userProfile, characterGroups, theme: osTheme, customThemes, realtimeConfig } = useOS();
